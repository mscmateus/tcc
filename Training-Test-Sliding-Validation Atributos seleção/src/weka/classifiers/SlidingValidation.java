...
public class SlidingValidation {
	...
	public String toClassifyMetricsString(int totalModels, Classifier algoritmo) throws Exception{
		StringBuffer text = new StringBuffer();
		attMatrixClassifiedData();
		//double precision = confusionMatrixPrecision(), recall = confusionMatrixRecall();
		text.append("\nAlgoritmo:   "+algoritmo.getClass().getName());
		...
		text.append(""+algoritmo.toString());
		escritor(""+algoritmo.toString());
		//text.append("\nRecall avg:                       "+ recall);
